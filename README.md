# Physical-AI-Edge-Robotics-Platform

Jetson-based Physical AI edge robotics reliability lab.

Start with the agent-readable PRD:

- [Jetson Physical AI PRD](docs/prd/Jetson_Physical_AI_PRD.md)
- [Backlog roadmap](docs/backlog/00_roadmap.md)
